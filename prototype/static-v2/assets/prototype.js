(function () {
  ...
  document.documentElement.setAttribute("data-prototype-version", "2");

  document.querySelectorAll('[role="status"]').forEach(function (element) {
    element.setAttribute("aria-live", "polite");
  });

  document.querySelectorAll('[role="alert"]').forEach(function (element) {
